 ...
 *
 * The "lambda expression" assigned to an object of "ObjIntConsumer" type is used to define its "accept()" which
 * eventually applies the given operation on its argument.
 *
 * It takes in a "int-valued" and a "T-valued" argument and is expected to operate without any side effects.
 * It is more like using an object of type "BiConsumer<T, Int>" except the fact that one is a reference and one is a
 ...
 */
public class ObjIntConsumerMain {
